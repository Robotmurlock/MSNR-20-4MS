...
Sa slike (\ref{fig:bagovi}) vidimo da su nejčešći razlozi za teške bragove upravo rastojanje od izvora greške do neočekivanog ponašanja. U ovim situacijama su veoma bitne metode debagovanja, pa i alati koji se koriste za debagovanje (debageri).
...
\section{Koja razvojna okruzenja podržavaju upotrebu ovog debagera i kako?}
...
\end{itemize}
\subsection{Eclipse}
U Eclipse razvojnom okruženju se korišćenje omogućava instaliranjem Eclipse dodataka\cite{eclipse_plugin} koji integrše postojeći lldb na sistemu sa eclipse razvojnim okruženjem. Radi na svim platformama koje podržava lldb i eclipse. Za razliku od VCS ima nekoliko ograničenja:
...
\subsection{CLion}
LLDB dolazi u paketu zajedno sa CLion razvojnim okruženjem na Linux i macOS platformama\cite{clion_lldb}. Postoji i eksperemintalna verzija LLDB baziranog debagera sa MSVC razvojne alate na Windows platformi. \\
...
Dostupne funkcionalnosti variraiju od platforme kao što se može videti u tabeli \ref{tab:table lldb features}.
...
>>>>>>> c7b84072c8a664be9d637737dd30a345e2fae43c
...
Najlakša integracija sa razvojnim okruženjem je trenutno u CLion-u gde LLDB dolazi zajedno u paketu sa ovim razvojim okruženjem i ne zahteva nikakva dodatna podešavanja ili kao dodatak u Visual Studio Code. Na Windows platformi je trenutno najbolje koristiti Microsoft-ov debager jer je najbolje integrisan sa Visual Studio-om, ali se očekuje da će u bliskoj budućnosti kvalitet LLDB na Windows platformama dostići nivo da će moće da parira Microsoft-ovom. Ukoliko je projekat za macOS platformu onda LLDB zasigurno pravi izbor jer je podrazumevani debager za ovu platformu i odlično je integrisan sa XCode5 razvojnim okruženjem. Za Linux korisnike LLDB nudi mnoštvo funkcionalnosti koje ne postoje u GDB-u kao i poboljšane performanse, tako da ako projekat to dozvoljava LLDB je pravi izbor i na Linux platformi. 
